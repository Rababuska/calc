...
window.ProductModules['leaflet'] = {
    calcLayout: function(sel, config, papers, sizes, laminations) {
        ...
        let itemW = (sel.size === 'custom') ? sel.custom_width : sizes.leaflet[sel.size].w;
        let itemH = (sel.size === 'custom') ? sel.custom_height : sizes.leaflet[sel.size].h;
